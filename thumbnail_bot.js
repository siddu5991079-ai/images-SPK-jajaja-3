...
const TARGET_URL = process.env.TARGET_URL || 'https://dlstreams.com/watch.php?id=598';
...
async function startThumbnailBot() {
    ...
    thumbnailInterval = setInterval(async () => {
        try {
            ...
            // 1. Take raw screenshot from LIVE stream
